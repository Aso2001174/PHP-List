...
<form action="prince-delete-result.php" method="post">
    <p>削除する番号を入力してください</p>
    <label class="effect">
    <p><input class="box" type="text" name="number"></p><br>
    </label>
    <p><input class="btn" type="submit" value="削除"></p><br>
</form>
<?php
